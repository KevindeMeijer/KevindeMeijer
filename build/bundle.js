    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", section_class_value = "" + (null_to_empty(/*$$props*/ ctx[0].class) + " svelte-njlar1"));
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$$props*/ 1 && section_class_value !== (section_class_value = "" + (null_to_empty(/*$$props*/ ctx[0].class) + " svelte-njlar1"))) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(i, "class", i_class_value = "" + (null_to_empty(/*fa_icon*/ ctx[2]) + " svelte-fr1asf"));
    			add_location(i, file$3, 17, 8, 369);
    			attr_dev(div0, "class", "icon svelte-fr1asf");
    			add_location(div0, file$3, 16, 6, 341);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*color*/ ctx[1]) + " svelte-fr1asf"));
    			add_location(div1, file$3, 15, 4, 314);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "href", /*link*/ ctx[0]);
    			attr_dev(a, "class", "svelte-fr1asf");
    			add_location(a, file$3, 14, 2, 277);
    			attr_dev(div2, "class", "socials svelte-fr1asf");
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*fa_icon*/ 4 && i_class_value !== (i_class_value = "" + (null_to_empty(/*fa_icon*/ ctx[2]) + " svelte-fr1asf"))) {
    				attr_dev(i, "class", i_class_value);
    			}

    			if (dirty & /*color*/ 2 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*color*/ ctx[1]) + " svelte-fr1asf"))) {
